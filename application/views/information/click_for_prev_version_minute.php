<?php
echo form_open('information/view_minute');
...
?>
				<div id='dropdown_for_ver' <?php if(!isset($selected_ver)) echo 'style="visibility:hidden"'; ?> >
					<?php
						if($prev_ver == NULL)
						{
							echo '<font color="red">There is no any previous version for the selected minute</font>';
						}
						else
						{
					?>
					...
					<span style="display: inline-block; margin: 0px 20px">
						<?php
							echo form_hidden('minute_id',$selected);
