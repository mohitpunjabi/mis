	...
	if($presult && $uresult && $qresult && $rresult)
	{
		...
		if($result1)
		{
			if(is_auth('deo'))
			{
				...
				//notify employee
				notify($_POST['emp_id'], "Details Edited", "Your basic details have been successfully edited by Data Entry Operator ".$_SESSION['id']." and sent for validation", "show_emp.php?form_name=0");
