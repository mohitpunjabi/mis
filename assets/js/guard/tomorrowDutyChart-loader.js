		...
		(function() {
			...
			for(var i = 0; i < users.length; i++) {
				data[i] = [
					...
					'<center><a href="'+base_url()+'index.php/guard/duties/replace/'+users[i].Regno+'/'+users[i].post_id+'/'+users[i].shift+'/'+users[i].date+'" onclick="return confirm(\'Are you sure you want to replace?\')">Replace</a></center>',
					'<center><a href="'+base_url()+'index.php/guard/duties/remove/'+users[i].Regno+'/'+users[i].post_id+'/'+users[i].shift+'/'+users[i].date+'" onclick="return confirm(\'Are you sure you want to remove?\')">Remove</a></center>'
				];
			}
