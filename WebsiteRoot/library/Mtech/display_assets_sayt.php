...
<table align="center">
 ...
 <?php
	...
	$extract = mysql_query("SELECT category,no_copies from categories_books where category like '%$q%' group by category ") or die(mysql_error());
	if(mysql_num_rows($extract)==0)
	{
		echo "<tr><center><td>No entry in this Section</td></tr>";
