			...
			<tr>
				...
				<td>
					<? 
				  			...
				  			else if ($pce_approved_status == "Pending") 
				  				echo "Pending";
				  			else
				  				echo "-"; 
				  		?>
...
?>
			<tr>
				<th colspan="2"><a href="<?php echo site_url("edc_booking/guest_details/get_guests/".$app_num);?>"><center>Guest Details</center></a></th>
			<tr>
<?
		$table->close();
	$box->close();	
