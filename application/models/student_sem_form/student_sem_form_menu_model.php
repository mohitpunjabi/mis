...
class Student_sem_form_menu_model extends CI_Model
{
	...
	function getMenu()
	{
		...
		$menu['stu']["Semester Registration"]["Semster Form"] = site_url('student_sem_form/regular_form');
		//auth ==> hod
		$menu['hod']=array();
		$menu['hod']["Semester Approved"]["Semster Form"] = site_url('student_sem_form/regular_check');
		}
		//auth ==> deo
		$menu['deo']=array();
