...
class Information_menu_model extends CI_Model
{
	...
	function getMenu()
	{
		...
		//auth ==> emp
		$menu['emp']=array();
		$menu['emp']["View Notice, Circular or Minute"] = array();
		$menu['emp']["View Notice, Circular or Minute"]['Notice'] = site_url('information/view_notice');
		$menu['emp']["View Notice, Circular or Minute"]['Circular'] = site_url('information/view_circular');
		$menu['emp']["View Notice, Circular or Minute"]['Minute'] = site_url('information/view_minute');
		
		//auth ==> stu
		$menu['stu']=array();
		$menu['stu']["View Notice, Circular or Minute"] = array();
		$menu['stu']["View Notice, Circular or Minute"]['Notice'] = site_url('information/view_notice');
		$menu['stu']["View Notice, Circular or Minute"]['Circular'] = site_url('information/view_circular');
		$menu['stu']["View Notice, Circular or Minute"]['Minute'] = site_url('information/view_minute');
		...
		$menu['est_ar']["Notices, Circulars or Minutes"]["Post"]['Minute'] = site_url('information/post_minute/index/est_ar');
		...
		$menu['est_ar']["Notices, Circulars or Minutes"]["Edit"]['Minute'] = site_url('information/edit_minute/index/est_ar');
		...
		$menu['est_ar']["Notices, Circulars or Minutes"]["View"]['Minute'] = site_url('information/view_minute');
		...
		$menu['hod']["Notices, Circulars or Minutes"]["Post"]['Minute'] = site_url('information/post_minute/index/hod');
		...
		$menu['hod']["Notices, Circulars or Minutes"]["Edit"]['Minute'] = site_url('information/edit_minute/index/hod');
		...
		$menu['hod']["Notices, Circulars or Minutes"]["View"]['Minute'] = site_url('information/view_minute');
		...
		$menu['exam_dr']["Notices, Circulars or Minutes"]["Post"]['Minute'] = site_url('information/post_minute/index/exam_dr');
		...
		$menu['exam_dr']["Notices, Circulars or Minutes"]["Edit"]['Minute'] = site_url('information/edit_minute/index/exam_dr');
		...
		$menu['exam_dr']["Notices, Circulars or Minutes"]["View"]['Minute'] = site_url('information/view_minute');
		...
		$menu['dt']["Notices, Circulars or Minutes"]["Post"]['Minute'] = site_url('information/post_minute/index/dt');
		...
		$menu['dt']["Notices, Circulars or Minutes"]["Edit"]['Minute'] = site_url('information/edit_minute/index/dt');
		...
		$menu['dt']["Notices, Circulars or Minutes"]["View"]['Minute'] = site_url('information/view_minute');
		...
		$menu['dsw']["Notices, Circulars or Minutes"]["Post"]['Minute'] = site_url('information/post_minute/index/dsw');
		...
		$menu['dsw']["Notices, Circulars or Minutes"]["Edit"]['Minute'] = site_url('information/edit_minute/index/dsw');
		...
		$menu['dsw']["Notices, Circulars or Minutes"]["View"]['Minute'] = site_url('information/view_minute');
		
		
		//auth ==> deo
		$menu['deo']=array();
		$menu['deo']["View Notice, Circular or Minute"] = array();
		$menu['deo']["View Notice, Circular or Minute"]['Notice'] = site_url('information/view_notice');
		$menu['deo']["View Notice, Circular or Minute"]['Circular'] = site_url('information/view_circular');
		$menu['deo']["View Notice, Circular or Minute"]['Minute'] = site_url('information/view_minute');
