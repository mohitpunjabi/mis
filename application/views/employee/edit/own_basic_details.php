...
<?php  echo form_open('employee/edit/update_own_basic_details/'.$emp_id);   ?>
...
<table width='90%'>
	...
	<tr>
        ...
        <td>
        	<input  type="text" name = "firstname" required value="<?= $user_details->first_name ?>" disabled >
        </td>
    </tr>
   	<tr>
    	<td>
        ...
        <td>
        	<input type="text" name = "middlename" value="<?= $user_details->middle_name ?>" disabled >
        </td>
        <td>
        	Last Name
        </td>
        <td>
        	<input type="text" name = "lastname" value= <?= $user_details->last_name ?> disabled >
        </td>
   </tr>
   <tr>
    	<td>
        ...
        <td>
        	<input type="radio" name="sex" value="m" <?php if($user_details->sex=='male' || $user_details->sex=='m') echo 'checked="checked"'; ?> disabled >Male</input>
            <input type="radio" name="sex" value="f" <?php if($user_details->sex=='female' || $user_details->sex=='f') echo 'checked="checked"';?> disabled >Female</input>
        </td>
        <td>
        	Nationality<span style= "color:red;"> *</span>
        </td>
        <td>
        	<input type="text" name="nationality" required value="<?= $user_other_details->nationality ?>" disabled >
        </td>
   </tr>
   <tr>
    	<td>
        ...
        <td>
        	<input type="text" name="father" required value="<?= $user_other_details->father_name ?>" disabled >
        </td>
        <td>
			Mother's Name<span style= "color:red;"> *</span>
        </td>
        <td>
        	<input type="text" name="mother" required value="<?= $user_other_details->mother_name ?>" disabled >
        </td>
   </tr>
   <tr>
    	<td>
        ...
        <td>
        	<select name="tstatus" onChange="teaching_handler(this.value);" id="teaching" disabled >
   ...
   <tr>
    	...
    	<td>
			<input type="radio" name="kashmiri" value="yes" <?php if($user_other_details->kashmiri_immigrant=='yes') echo 'checked="checked"'; ?>  disabled />Yes
            <input type="radio" name="kashmiri" value="no" <?php if($user_other_details->kashmiri_immigrant=='no') echo 'checked="checked"'; ?>  disabled />No
        </td>
    </tr>
    <tr>
       	<td>
    	...
    	<td>
			<input type="date" name="entrance_age" value="<?php echo $emp->joining_date;?>" required  disabled >
        </td>
    	<td>
        	Designation<span style= "color:red;"> *</span>
        </td>
    	<td>
	        <select name="designation" id="des"  disabled >
            	<?php
    ...
    <tr>
    	...
    	<td>
  	      	<input type="text" name="religion" value="<?php echo $user_other_details->religion; ?>" required disabled >
        </td>
    </tr>
    <tr>
    	<td>
    	...
    	<td>
  	      	<input type="date" name="dob"  value=<?= $user_details->dob ?> max=<?php echo date("Y-m-d", time()); ?> disabled >
        </td>
    	<td>
        	Place of Birth<span style= "color:red;"> *</span>
        </td>
    	<td>
  	      	<input type="text" name="pob" value=<?= $user_other_details->birth_place ?> required disabled >
        </td>
    </tr>
    <tr>
    	<td>
    	...
    	<td>
        	<select name="payscale" tabindex="26"  required onChange="payband_handler(this.value);" disabled >
            ...
            <select name="gradepay" required tabindex="26" disabled >
				<?php
            ...
            <input type="text" name="basicpay" required id="basicpay" size="10"  placeholder="Basic Pay" value="<?= $emp_pay_details->basic_pay ?>" disabled />
        </td>
        <td>Nature of Employment<span style= "color:red;"> *</span></td>
       	<td>
            <select name="empnature" disabled >
   ...
   <tr>
    	...
    	<td>
  	      	<select name="department" id="depts" disabled >
            	<?php
            		if($emp->auth_id == 'ft')
        ...
        <td>
        	<input type="date" name="retire" id="retire" value="<?= $emp->retirement_date;?>" disabled />
        </td>
    </tr>
    <tr>
...
<?php echo form_close(); ?>
<a href= <?= site_url('employee/menu')?> ><button>Back</button></a>