...
class Leave_menu_model extends CI_Model{
    ...
    function getMenu(){
        ...
        $menu['hod']['Leave Management']['Station Leave']['Leave Approved/Rejected/Forwarded by You'] = site_url('leave/leave_station/adminLeaveHistory');
        ...
        $menu['est_ar']['Leave Management']['Station Leave']['Leave Approved/Rejected/Forwarded by You'] = site_url('leave/leave_station/adminLeaveHistory');
        ...
        $menu['astreg']['Leave Management']['Station Leave']['Leave Approved/Rejected/Forwarded by You'] = site_url('leave/leave_station/adminLeaveHistory');
        ...
        $menu['dir']['Leave Management']['Station Leave']['Leave Approved/Rejected/Forwarded by You'] = site_url('leave/leave_station/adminLeaveHistory');
        ...
        $menu['dyreg']['Leave Management']['Station Leave']['Leave Approved/Rejected/Forwarded by You'] = site_url('leave/leave_station/adminLeaveHistory');
