	...
	else
{
	...
	echo "<span><h3>Requests</h3><br><br></span>";			
	echo " 
  			<tr>
		    <th>Request No.</th>
    		<th>Employee Name</th>
	...
	while($row=mysql_fetch_assoc($extract))
	{
	   ...
	   echo " <div id=\"light"; echo $i; echo "\" style=\"display:none\" class=\"white_content\">";
				...
				echo "<span class='style4'>Request No. :".$req_num."<br><br>Name of Indentor:".$emp_name. "<br><br>Designation :".$design."<br><br>
				Book Name :".$book_name."<br><br>Author :".$author."<br><br> Publication :".$publication."<br><br> Edition :".$edition."
				<br><br> no_copies".$no_copies."<br><br> Price/unit :".$price."<br><br> Date of Request:".$date."</span>";
  ...
  "</tr> ";
	...
	?>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
 		 <tr>
  				  <td width="977" height="32"><a href="request.php">REQUEST A BOOK OTHER THAN ABOVE REQUESTS</a></td>
   				  <td width="132">&nbsp;</td>
 		 </tr>
