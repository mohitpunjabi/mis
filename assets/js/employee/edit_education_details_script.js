	...
	function onclick_delete(i)
	{
		...
		if(result==true)
		{
			...
			xmlhttp.onreadystatechange=function()
		  	...
		  	xmlhttp.open("POST",js_base_url()+"employee/emp_ajax/delete_record/4/"+i,true);
			xmlhttp.send();
		}
	}
	...
	function onclick_edit(i)
	{
		...
		var x = '<form action="'+js_base_url()+'employee/edit/update_old_education_details/'+i+'" onSubmit="return onclick_save('+i+');" method="post" accept-charset="utf-8" >';
		x+='<table><tr>';
