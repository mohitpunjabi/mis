...
/*			$status = $this->input->post ('status');
			...
			if ($status == "Approved")
				$this->notification->notify ($user_id, "emp", "EDC Room Allotment Request", "Your Request for EDC Room Allotment (Application No. : ".$app_num." ) is has been Approved. Click know more to see Allocated Rooms.", "edc_booking/guest_details/get_guests/".$app_num, "");
			else
