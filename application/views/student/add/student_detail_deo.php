...
//                        $lastname_column->close();
                ...
                /*$student_educational_details_box = $ui->box()
                    ...
                    $educational_details_row_1 = $ui->row()
                        ...
                        $educational_detail_col_1_1 = $ui->col()
                                                       ->width(1)
                                                       ->open();
                            echo '<label>S No.</label>';

                        $educational_detail_col_1_1->close();

                        $educational_detail_col_1_2 = $ui->col()
                                                       ->width(1)
                                                       ->open();
                            echo '<label>Examination</label>';

                        $educational_detail_col_1_2->close();

                        $educational_detail_col_1_3 = $ui->col()
                                                       ->width(2)
                                                       ->open();
                            echo '<label>Branch/Specialization</label>';

                        $educational_detail_col_1_3->close();

                        $educational_detail_col_1_4 = $ui->col()
                                                       ->width(3)
                                                       ->open();
                            echo '<label>School/College/University/Institute</label>';

                        $educational_detail_col_1_4->close();

                        $educational_detail_col_1_5 = $ui->col()
                                                       ->width(2)
                                                       ->open();
                            echo '<label>Year</label>';

                        $educational_detail_col_1_5->close();

                        $educational_detail_col_1_6 = $ui->col()
                                                       ->width(1)
                                                       ->open();
                            echo '<label>Percentage/Grade</label>';

                        $educational_detail_col_1_6->close();

                        $educational_detail_col_1_7 = $ui->col()
                                                       ->width(2)
                                                       ->open();
                            echo '<label>Class/Division</label>';

                        $educational_detail_col_1_7->close();
                    ...
                    $educational_details_row_2 = $ui->row()
                        ...
                        $educational_detail_col_2_1 = $ui->col()
                                                       ->width(1)
                                                       ->open();

                            echo '1';

                        $educational_detail_col_2_1->close();

                        $educational_detail_col_2_2 = $ui->col()
                                                       ->width(1)
                                                       ->open();
                        ...
                        $educational_detail_col_2_2->close();

                        $educational_detail_col_2_3 = $ui->col()
                                                       ->width(2)
                                                       ->open();
                        ...
                        $educational_detail_col_2_3->close();

                        $educational_detail_col_2_4 = $ui->col()
                                                       ->width(3)
                                                       ->open();
                        ...
                        $educational_detail_col_2_4->close();

                        $educational_detail_col_2_5 = $ui->col()
                                                       ->width(2)
                                                       ->open();
                        ...
                        $educational_detail_col_2_5->close();

                        $educational_detail_col_2_6 = $ui->col()
                                                       ->width(1)
                                                       ->open();
                        ...
                        $educational_detail_col_2_6->close();

                        $educational_detail_col_2_7 = $ui->col()
                                                       ->width(2)
                                                       ->open();
                        ...
                        $educational_detail_col_2_7->close();
