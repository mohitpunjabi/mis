...
<table align="center">
 ...
 <?php
 	$count=0;
	require("connect.php");
	$extract = mysql_query("SELECT sum(no_copies) as sumcopies from categories_books") or die(mysql_error());
	...
	$extract1 = mysql_query("SELECT category,no_copies from categories_books group by category ") or die(mysql_error());
