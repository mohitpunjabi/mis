    ...
    <?php 
		echo form_open('information/edit_notice');
		echo form_hidden('notice_id',$notice_row->notice_id);
		echo form_hidden('notice_no',$notice_row->notice_no);
		echo form_hidden('notice_cat',$notice_row->notice_cat);
		echo form_hidden('notice_sub',$notice_row->notice_sub);
		echo form_hidden('notice_path',$notice_row->notice_path);
		echo form_hidden('last_date',$notice_row->last_date);
